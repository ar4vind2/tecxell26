export const eventsData = [
    ...
    },
    {
        ...
        rules: [
            ...
            'If no.of participants are odd or no.of matches are not equal 1 or 2 participants will be randomly tossed to the next round',
            'The random toss will be conducted at the start of the tournament and the match fixtures will be shown lively on the screen',
